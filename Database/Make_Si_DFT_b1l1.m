...
Si_DFT_b1l1.Composition.Z = Si_DFT_b1l1.Z;
...
for i = 1:numel(E0)
    Si_DFT_b1l1.Elastic.sigma_el(i) = data(i).sigma_el;
...
dft_data = load([dirData 'elf_si_dft+bse_ocean_0_01_b1l1.mat']);
Si_DFT_b1l1.ELF = dft_data.elf;
Si_DFT_b1l1.eloss = dft_data.omega;
Si_DFT_b1l1.q = dft_data.q;
...
for i = 1:length(E0)
    if E0(i) > 2*Si_DFT_b1l1.Eg + Si_DFT_b1l1.Evb
        ...
        eloss = Si_DFT_b1l1.Eg:(energy-Si_DFT_b1l1.Eg)/(N-1):energy;
        if energy < 10
            osc.eloss = Si_DFT_b1l1.Eg:0.01:energy;
        else
            osc.eloss = Si_DFT_b1l1.Eg:0.2:energy;
        end
        Si_DFT_b1l1.DIIMFP(:,1,i) = eloss;
        [iimfp, diimfp] = ndiimfp(osc,E0(i),Si_DFT_b1l1.ELF,Si_DFT_b1l1.q,Si_DFT_b1l1.eloss);
        Si_DFT_b1l1.DIIMFP(:,2,i) = interp1(osc.eloss,diimfp,eloss);
