...
for i = 1:numel(E0)
    PS_MLL.Elastic.l_el(i) = 1/data(i).sigma_el/PS_MLL.Density;
    PS_MLL.Elastic.l_tr(i) = 1/data(i).sigma_tr1/PS_MLL.Density;
    PS_MLL.DECS.y(:,i) = data(i).y/trapz(data(i).x,data(i).y);
end
