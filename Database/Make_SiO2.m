...
SiO2.Evb = 10;
SiO2.Affinity = 1.1;
SiO2.Phonon.eps_zero = 3.84; % static dielectric constant
SiO2.Phonon.eps_inf = 2.25; % high-frequency dielectric constant (the square of the static refractive index)
