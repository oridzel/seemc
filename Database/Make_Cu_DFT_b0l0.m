...
%% Basic
Cu_DFT_b0l0.Mat = 'Cu_DFT_b0l0';
Cu_DFT_b0l0.M = 63.546;
Cu_DFT_b0l0.Z = 29;
Cu_DFT_b0l0.Density = 8.96; %g/cm^3
Cu_DFT_b0l0.Density = Cu_DFT_b0l0.Density*10^-24/Cu_DFT_b0l0.M*6.022*10^23; %#/A^3
Cu_DFT_b0l0.NvTPP = 11;
...
Cu_DFT_b0l0.Elastic.x = E0;
Cu_DFT_b0l0.DECS.E0 = E0;
Cu_DFT_b0l0.Composition.Z = Cu_DFT_b0l0.Z;
Cu_DFT_b0l0.Composition.index = 1;

tic;
[data] = ElsepaRunner.RunElsepa(Cu_DFT_b0l0.Composition,E0);
toc
Cu_DFT_b0l0.DECS.x = data(1).x;
for i = 1:numel(E0)
    Cu_DFT_b0l0.Elastic.sigma_el(i) = data(i).sigma_el;
    Cu_DFT_b0l0.Elastic.l_el(i) = 1/(data(i).sigma_el*a0^2)/Cu_DFT_b0l0.Density;
    Cu_DFT_b0l0.Elastic.l_tr(i) = 1/(data(i).sigma_tr1*a0^2)/Cu_DFT_b0l0.Density;
...
%% Ionisation shells
Cu_DFT_b0l0.Shells = {'2S1/2';'2P1/2';'2P3/2';'3S1/2';'3P1/2';'3P3/2';'3D3/2';'3D5/2';'4S1/2';};
Cu_DFT_b0l0.EB = [1103;958;938;127;82;80;11;10;8;];
