...
for i = 1:numel(E0)
    Cu_DFT_b1l0.Elastic.l_el(i) = 1/data(i).sigma_el/Cu_DFT_b1l0.Density;
    Cu_DFT_b1l0.Elastic.l_tr(i) = 1/data(i).sigma_tr1/Cu_DFT_b1l0.Density;
    Cu_DFT_b1l0.DECS.y(:,i) = data(i).y/trapz(data(i).x,data(i).y);
end
%}
...
load([dirData 'elf_cu_dft+bse_20kp_ocean_0_01_b1l0.mat'])
Cu_DFT_b1l0.ELF = elf;
Cu_DFT_b1l0.eloss = omega;
Cu_DFT_b1l0.q = q;
...
for i = 1:length(E0)
    if E0(i) > Cu_DFT_b1l0.Ef
        ...
        Cu_DFT_b1l0.DIIMFP(:,1,i) = osc.eloss;
        [iimfp, Cu_DFT_b1l0.DIIMFP(:,2,i)] = ndiimfp(osc,E0(i),elf,q,omega);
